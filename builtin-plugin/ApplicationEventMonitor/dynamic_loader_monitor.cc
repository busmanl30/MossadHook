...
#endif
  MossadHook((void *)MossadSymbolResolver(NULL, "__loader_dlopen"), (void *)fake_loader_dlopen,
            (void **)&orig_loader_dlopen);
#else
  MossadHook((void *)MossadSymbolResolver(NULL, "dlopen"), (void *)fake_dlopen, (void **)&orig_dlopen);
#endif

  MossadHook((void *)dlsym, (void *)fake_dlsym, (void **)&orig_dlsym);
  MossadHook((void *)dlclose, (void *)fake_dlclose, (void **)&orig_dlclose);
}
#endif
