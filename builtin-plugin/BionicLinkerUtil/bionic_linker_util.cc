...
#include "mossad.h"
#include "mossad_symbol_resolver.h"
...
#undef Q
#define Q 29
// impl at "mossad_symbol_resolver.cc"
...
PUBLIC void *linker_dlopen(const char *filename, int flag) {
  ...
  if (!__loader_dlopen)
    __loader_dlopen = (__loader_dlopen_t)MossadSymbolResolver(NULL, "__loader_dlopen");
...
void linker_disable_namespace_restriction() {
  ...
  MossadHook(linker_namespace_is_is_accessible_ptr, (void *)linker_namespace_is_is_accessible,
