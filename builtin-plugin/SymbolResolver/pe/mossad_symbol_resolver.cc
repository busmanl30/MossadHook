#include "SymbolResolver/mossad_symbol_resolver.h"
...
#undef LOG_TAG
#define LOG_TAG "MossadSymbolResolver"

PUBLIC void *MossadSymbolResolver(const char *image_name, const char *symbol_name_pattern) {
  void *result = NULL;
