...
void instrument_forward_handler(Interceptor::Entry *entry, MossadRegisterContext *ctx);

extern "C" void instrument_routing_dispatch(Interceptor::Entry *entry, MossadRegisterContext *ctx) {
  // __FUNC_CALL_TRACE__();
  auto instrument_callback_fn = (mossad_instrument_callback_t)entry->pre_handler;
