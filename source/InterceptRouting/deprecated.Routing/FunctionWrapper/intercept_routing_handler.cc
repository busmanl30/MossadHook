...
void pre_call_forward_handler(MossadRegisterContext *ctx, InterceptEntry *entry) {
...
void post_call_forward_handler(MossadRegisterContext *ctx, InterceptEntry *entry) {
  FunctionWrapperRouting *routing = (FunctionWrapperRouting *)entry->routing;
...
void prologue_routing_dispatch(MossadRegisterContext *ctx, ClosureTrampolineEntry *closure_trampoline_entry) {
...
void epilogue_routing_dispatch(MossadRegisterContext *ctx, ClosureTrampolineEntry *closure_trampoline_entry) {
