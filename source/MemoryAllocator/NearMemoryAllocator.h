...
inline mossad_alloc_near_code_callback_t custom_alloc_near_code_handler = nullptr;
PUBLIC inline void mossad_register_alloc_near_code_callback(mossad_alloc_near_code_callback_t handler) {
