...
PUBLIC extern "C" inline void common_closure_bridge_handler(MossadRegisterContext *ctx, ClosureTrampoline *tramp) {
  typedef void (*routing_handler_t)(Interceptor::Entry *, MossadRegisterContext *);
